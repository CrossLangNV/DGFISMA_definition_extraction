...
if __name__ == "__main__":
    ...
    parser.add_argument("--filename", dest="FILENAME",
                        help='Path to the test data. A csv with at each line: "plain text"￭label_tag￭label_nr. The plain text should be enclosed in ".."',
                        required=True)
    ...
    dataset = pd.read_csv(FILENAME, delimiter=DELIMITER, quoting=csv.QUOTE_NONE, header=None, engine='python',
    ...
    model.eval()
    # Tracking variables 
    predictions_label, predictions_proba, true_labels = [], [], []
    # Predict 
    ...
    print(f"accuracy:{accuracy_score(labels, predictions_labels)}")
    print(classification_report(labels, predictions_labels))
